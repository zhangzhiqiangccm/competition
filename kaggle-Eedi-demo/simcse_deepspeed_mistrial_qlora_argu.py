...
def main():
    ...
    train_dataloader = DataLoader(train_dataset,
                                  ...
                                  collate_fn=EmbedCollator(tokenizer, query_max_len=args.query_max_len, passage_max_len=args.passage_max_len),
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if args.save_batch_steps and (global_step + 1) % args.save_batch_steps == 0 and (is_rank_0() or args.zero_stage == 3 or True):
                loss_mean = 0.
...
def parse_args():
    ...
    parser.add_argument('--query_instruction_for_retrieval', type=str, default=None, help='query_instruction_for_retrieval')
    parser.add_argument('--passage_instruction_for_retrieval', type=str, default=None, help='passage_instruction_for_retrieval')
    ...
    parser.add_argument('--lora_learning_rate', type=float, default=5e-4, help='Initial LoRA learning rate (after the potential warmup period) to use.')
    ...
    parser.add_argument('--lora_config', type=str, default='./configs/lora_config_llama.json', help='If > 0, use LoRA for efficient training.')
